...
export default function App() {
  ...
  function updateFinalOutput() {
      ...
      finalOutput += "\nAssociate Developers/Designers (P="+staff.associateDevelopers.filter(person => person.status === "P").length+"/A="+staff.associateDevelopers.filter(person => person.status === "A").length+"/TO=0/WFH="+staff.associateDevelopers.filter(person => person.status === "WFH").length+"/OS="+staff.associateDevelopers.filter(person => person.status === "OS").length+")\n" 
